...
const faqs = [
  [
    {
      question: 'Can I invite my classmates or team members to join my ReQuest projects?',
      answer:
    ...
    {
      question: 'How does the AI integration in ReQuest help in managing requirements?',
      answer:
  ...
  [
    {
      question: 'Can I export or share my requirements from ReQuest with others?',
      answer:
    ...
    {
      question: 'Does ReQuest offer any templates or pre-defined requirement structures?',
      answer:
  ...
  [
    ...
    {
      question: 'Can ReQuest be integrated with other project management tools or platforms?',
      answer:
    ...
    {
      question: 'Does ReQuest offer any notifications or reminders for upcoming deadlines or task assignments?',
      answer:
              ...
              <ul role="list" className="space-y-10">
                {column.map((faq, faqIndex) => (
                  <li key={faqIndex}>
                    ...
                    <p className="mt-4 text-sm text-gray-700 text-justify">{faq.answer}</p>
                  </li>
                ))}
              </ul>
            </li>
