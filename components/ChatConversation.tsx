        ...
        <>
          {
            message.is_user ? (
              <div className="flex flex-row chat chat-end justify-end">
                <div className="chat chat-bubble chat-bubble-primary text-white text-justify"
                  data-theme="chat">
                  {message.content}
                </div>
              </div >
              ...
              <div className="flex flex-row chat chat-start">
                <div className="chat chat-bubble chat-bubble-secondary text-black text-justify"
                  data-theme="chat">
                  {message.content}
                </div>
              </div>
